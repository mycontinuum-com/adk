...
export function rateLimitHandler(options: RateLimitHandlerOptions = {}): ErrorHandler {
...
export function timeoutHandler(options: TimeoutHandlerOptions = {}): ErrorHandler {
  return {
    name: 'timeout',
...
export function loggingHandler(options: LoggingHandlerOptions = {}): ErrorHandler {
  const log =
    options.onError ??
    ((ctx) => {
