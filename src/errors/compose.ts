...
import type { ErrorHandler, ErrorRecovery, ComposedErrorHandler } from './types'

export function composeErrorHandlers(
  runnerHandlers: readonly ErrorHandler[],
  agentHandlers: readonly ErrorHandler[],
  callSiteHandlers: readonly ErrorHandler[] = [],
): ComposedErrorHandler {
  const allHandlers = [...runnerHandlers, ...agentHandlers, ...callSiteHandlers]
