...
export function createContext(partial: boolean, visited?: Set<string>, depth = 0): CoercionContext {
  return {
    path: [],
    corrections: [],
    errors: [],
...
export function childContext(ctx: CoercionContext, key: string | number): CoercionContext {
  return {
...
function getVisitedKey(ctx: CoercionContext, schemaId: string, value: unknown): string {
...
export function checkAndMarkVisited(
  ...
  const key = getVisitedKey(ctx, schemaId, value)
