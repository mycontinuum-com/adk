...
export function coerceObject(
  ...
  return coerceObjectShared(
    ...
    schema.def.catchall instanceof z.ZodUnknown,
    ctx,
    coerceValue,
  )
}
...
export function coerceRecord(
  ...
  return coerceRecordShared(value, schema.valueType, ctx, coerceValue)
}
...
export function coerceTuple(
  ...
  return coerceTupleShared(value, schema.def.items, ctx, coerceValue)
}
...
export function coerceMap(
  ...
  return coerceMapShared(value, schema.keyType, schema.valueType, ctx, coerceValue)
}
