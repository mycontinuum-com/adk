...
export function coerceToString(value: unknown, ctx: CoercionContext): string | undefined {
  ...
  if (typeof value === 'number') {
    ...
    addCorrection(ctx, value, result, 'Coerced number to string', 'numberToString')
    return result
  }

  if (typeof value === 'boolean') {
    const result = String(value)
    addCorrection(ctx, value, result, 'Coerced boolean to string', 'booleanToString')
    return result
  }
  ...
  if (Array.isArray(value) && value.length === 1) {
    ...
    if (typeof item === 'string') {
      addCorrection(ctx, value, item, 'Unwrapped single-element array to string', 'singleToArray')
      return item
    }
  }
  ...
  if (typeof value === 'object' && value !== null && !Array.isArray(value)) {
    try {
      ...
      addCorrection(ctx, value, result, 'Converted object to JSON string', 'objectToString')
      return result
    } catch {
...
export function coerceToBigInt(value: unknown, ctx: CoercionContext): bigint | undefined {
  ...
  if (typeof value === 'number' && Number.isInteger(value)) {
    ...
    addCorrection(ctx, value, result, 'Coerced number to bigint', 'numberToBigInt')
    return result
  }
  ...
  if (typeof value === 'string') {
    try {
      ...
      addCorrection(ctx, value, result, 'Coerced string to bigint', 'stringToBigInt')
      return result
    } catch {
...
export function coerceToNumber(value: unknown, ctx: CoercionContext): number | undefined {
  ...
  if (typeof value === 'string') {
    ...
    if (!Number.isNaN(direct)) {
      addCorrection(ctx, value, direct, 'Coerced string to number', 'stringToNumber')
      return direct
    }
    ...
    if (fraction !== undefined) {
      addCorrection(ctx, value, fraction, 'Parsed fraction to number', 'fractionParsed')
      return fraction
    }
  ...
  if (typeof value === 'boolean') {
    ...
    addCorrection(ctx, value, result, 'Coerced boolean to number', 'booleanToNumber')
    return result
  }
...
export function coerceToBoolean(value: unknown, ctx: CoercionContext): boolean | undefined {
  ...
  if (typeof value === 'string') {
    ...
    if (lower === 'true' || lower === 'yes' || lower === '1') {
      addCorrection(ctx, value, true, 'Coerced string to boolean', 'stringToBool')
      return true
    }
    if (lower === 'false' || lower === 'no' || lower === '0') {
      addCorrection(ctx, value, false, 'Coerced string to boolean', 'stringToBool')
      return false
    }

    const trueMatch = matchFuzzy(value, ['true', 'True', 'TRUE', 'yes', 'Yes', 'YES'])
    if (trueMatch) {
      addCorrection(ctx, value, true, 'Matched boolean string fuzzily', 'stringToBool')
      return true
    }

    const falseMatch = matchFuzzy(value, ['false', 'False', 'FALSE', 'no', 'No', 'NO'])
    if (falseMatch) {
      addCorrection(ctx, value, false, 'Matched boolean string fuzzily', 'stringToBool')
      return false
    }
  }
  ...
  if (typeof value === 'number') {
    ...
    addCorrection(ctx, value, result, 'Coerced number to boolean', 'numberToBool')
    return result
  }
...
export function coerceToDate(value: unknown, ctx: CoercionContext): Date | undefined {
